...
┌──────────────────▼─────────────────────────────┐
│ Agent runtimes: Codex, Claude, Cursor, Grok,   │
│ Kimi, OpenCode, Ollama                         │
└────────────────────────────────────────────────┘
```
...
Codex, Claude, Cursor, Grok, Kimi, OpenCode, and Ollama. A driver declares its kind and config schema and creates a
